  ...
  <header class="site-header">
    <div class="wrap">
      <a href="index.html" class="brand">
        <span class="brand-name">Tri Vân</span>
        <span class="brand-desc">Tài liệu VNU và nhiều trường đại học khác</span>
      </a>
      <nav class="main-nav">${links}</nav>
      <div class="header-actions">
        <a href="huong-dan.html">Trợ giúp</a>
  ...
  <footer class="site-footer">
    <div class="wrap">
      <div class="footer-cols">
        ...
        <div>
          <span class="brand-name">Tri Vân</span>
          <p>Tài liệu VNU và nhiều trường đại học khác, chia sẻ tài liệu học tập và nghiên cứu khoa học dành cho sinh viên.</p>
        </div>
      ...
      <p class="copyright">© 2026 Tri Vân. All rights reserved.</p>
    </div>
  </footer>`;
}
...
function initFooterFeedback() {
  ...
  sendBtn.addEventListener("click", () => {
    ...
    const subject = encodeURIComponent(`[Tri Vân] ${currentType}`);
